...
class Quizbrain {
  ...
  void nextQuestion() {
    if (_questionNumber < _questionHub.length - 1) {
      _questionNumber++;
    }
  }
  ...
  String getQuestions() {
    return _questionHub[_questionNumber].questionText;
  }

  bool getAnswer() {
    return _questionHub[_questionNumber].questionAnswer;
  }
